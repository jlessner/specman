...
public class UndoableStepnumberLinkRemoved extends AbstractUndoableInteraction {
  private final AbstractSchrittView abstractSchrittView;
  private final TextEditArea textEditArea;

  public UndoableStepnumberLinkRemoved(AbstractSchrittView abstractSchrittView, TextEditArea textEditArea) {
