...
public class JEditorPaneLines2PDFTest extends JFrame implements ComponentListener {
  ...
  JEditorPaneLines2PDFTest() throws Exception {
    ...
    field.setText("eins<ul><li><b>&bull;</b>zwei zwei zwei zwei zwei zwei zwei<li>drei<li>dreieinhalb<ul><li>drei eins<li>drei zwei</ul></ul>vier<br><font size=\"6\">fünf</font><br>sechs");
